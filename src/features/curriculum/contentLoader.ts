import { parseContent, type AppChapter, type AppContent, type AppLesson, type AppMission, type AppPlaybook, type AppTrack, } from './contentSchema';
...
export function getPlaybookBySlug(content: AppContent, playbookSlug: string): AppPlaybook | undefined {
