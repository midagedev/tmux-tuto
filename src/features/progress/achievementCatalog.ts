...
const ACHIEVEMENTS: AchievementDefinition[] = [
  ...
  {
    id: 'skill_layout_first',
    category: 'skill',
    title: '레이아웃 장인',
    description: '실습 중 window layout을 적용했습니다.',
    shareText: '레이아웃 장인 업적을 달성했어요.',
  },
  {
    id: 'skill_zoom_control',
    category: 'skill',
    title: '줌 컨트롤',
    description: 'pane zoom 토글을 실행했습니다.',
    shareText: '줌 컨트롤 업적을 달성했어요.',
  },
  {
    id: 'skill_sync_control',
    category: 'skill',
    title: '동기화 지휘관',
    description: 'synchronize-panes를 활성화했습니다.',
    shareText: '동기화 지휘관 업적을 달성했어요.',
  },
  {
    id: 'skill_command_prompt',
    category: 'skill',
    title: '프롬프트 소환사',
    description: 'tmux command-prompt를 실행했습니다.',
    shareText: '프롬프트 소환사 업적을 달성했어요.',
  },
  {
    id: 'skill_choose_tree',
    category: 'skill',
    title: '트리 탐험가',
    description: 'choose-tree 인터페이스를 열었습니다.',
    shareText: '트리 탐험가 업적을 달성했어요.',
  },
  {
    id: 'skill_resize_5',
    category: 'skill',
    title: '미세조정',
    description: 'pane resize를 5회 이상 실행했습니다.',
    shareText: '미세조정 업적을 달성했어요.',
  },
  {
    id: 'skill_pane_navigator',
    category: 'skill',
    title: '패인 네비게이터',
    description: 'pane 선택/이동을 10회 이상 실행했습니다.',
    shareText: '패인 네비게이터 업적을 달성했어요.',
  },
  {
    id: 'skill_swap_first',
    category: 'skill',
    title: '자리 바꾸기',
    description: 'swap-pane를 처음 실행했습니다.',
    shareText: '자리 바꾸기 업적을 달성했어요.',
  },
  {
    id: 'skill_rotate_first',
    category: 'skill',
    title: '회전문',
    description: 'rotate-window를 처음 실행했습니다.',
    shareText: '회전문 업적을 달성했어요.',
  },
  {
