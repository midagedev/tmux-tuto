...
type TmuxStoreName = 'profile' | 'progress' | 'mission_attempts' | 'bookmarks' | 'notes' | 'achievements' | 'simulator_snapshots' | 'backup_meta';
...
export function applyMigrations(db: IDBPDatabase<TmuxTutoDB>, tx: MigrationTx, oldVersion: number, newVersion: number) {
