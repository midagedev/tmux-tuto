...
const LearnIndexPage = lazy(() => import('../pages/Learn/LearnIndexPage').then((module) => ({ default: module.LearnIndexPage })));
const LessonPage = lazy(() => import('../pages/Learn/LessonPage').then((module) => ({ default: module.LessonPage })));
const PracticePage = lazy(() => import('../pages/Practice/PracticePage').then((module) => ({ default: module.PracticePage })));
const PracticeVmPocPage = lazy(() => import('../pages/Practice/PracticeVmPocPage').then((module) => ({ default: module.PracticeVmPocPage })));
const CheatsheetPage = lazy(() => import('../pages/Cheatsheet/CheatsheetPage').then((module) => ({ default: module.CheatsheetPage })));
const PlaybookIndexPage = lazy(() => import('../pages/Playbooks/PlaybookIndexPage').then((module) => ({ default: module.PlaybookIndexPage })));
const PlaybookDetailPage = lazy(() => import('../pages/Playbooks/PlaybookDetailPage').then((module) => ({ default: module.PlaybookDetailPage })));
const PlaybookCopiedPage = lazy(() => import('../pages/Playbooks/PlaybookCopiedPage').then((module) => ({ default: module.PlaybookCopiedPage })));
...
const MissionPassedPage = lazy(() => import('../pages/Progress/MissionPassedPage').then((module) => ({ default: module.MissionPassedPage })));
const ShareMilestonePage = lazy(() => import('../pages/Share/ShareMilestonePage').then((module) => ({ default: module.ShareMilestonePage })));
const ShareAchievementPage = lazy(() => import('../pages/Share/ShareAchievementPage').then((module) => ({ default: module.ShareAchievementPage })));
const NotFoundPage = lazy(() => import('../pages/NotFoundPage').then((module) => ({ default: module.NotFoundPage })));
const OnboardingStartPage = lazy(() => import('../pages/Onboarding/OnboardingStartPage').then((module) => ({
    default: module.OnboardingStartPage,
})));
const OnboardingGoalPage = lazy(() => import('../pages/Onboarding/OnboardingGoalPage').then((module) => ({
    default: module.OnboardingGoalPage,
})));
const OnboardingPreferencesPage = lazy(() => import('../pages/Onboarding/OnboardingPreferencesPage').then((module) => ({
    default: module.OnboardingPreferencesPage,
})));
const OnboardingFirstMissionPage = lazy(() => import('../pages/Onboarding/OnboardingFirstMissionPage').then((module) => ({
    default: module.OnboardingFirstMissionPage,
})));
const OnboardingFirstMissionPassedPage = lazy(() => import('../pages/Onboarding/OnboardingFirstMissionPassedPage').then((module) => ({
    default: module.OnboardingFirstMissionPassedPage,
})));
const OnboardingDonePage = lazy(() => import('../pages/Onboarding/OnboardingDonePage').then((module) => ({
    default: module.OnboardingDonePage,
})));
function renderLazyPage(Component: ComponentType) {
    return (<LocalizedSuspense>
      <Component />
    </LocalizedSuspense>);
}
function LocalizedSuspense({ children }: {
    children: ReactNode;
}) {
    const { t } = useI18n();
